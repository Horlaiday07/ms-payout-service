...
public class MerchantLookupService {
    ...
    private Merchant toDomain(PayoutMerchantCachePayload p) {
        ...
        return Merchant.builder()
                ...
                .ledgerMerchantAccountId(p.getLedgerMerchantAccountId())
                .ledgerInternalAccountId(p.getLedgerInternalAccountId())
                .ledgerSettlementAccountId(p.getLedgerSettlementAccountId())
